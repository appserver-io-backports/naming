...
/**
 * TechDivision\Naming\NamingDirectoryTest
 *
 * NOTICE OF LICENSE
 *
...
class NamingDirectoryTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @var \TechDivision\Naming\NamingDirectory
     */
    ...
    public function testCreateSubdirectory()
    {
        ...
        $this->assertInstanceOf('TechDivision\Naming\NamingDirectoryInterface', $subdirectory);
